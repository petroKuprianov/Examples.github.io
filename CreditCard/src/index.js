var creditly =  (function () {
  ...
  var removeErrors = function (element, selector) {
    element.className = element.className.replace(/\bhas-error\b/, '');
    if (".section.gray_theme .security-code" === selector) {
      var element = document.getElementById("section__form-chek-3");
      element.style.visibility = "hidden";
    }
    if (".section.gray_theme .section__form-input-card" === selector) {
      var element = document.getElementById("section__form-chek-1");
      element.style.visibility = "hidden";
    }
    if (".section.gray_theme .expiration-month-and-year" === selector) {
      var element = document.getElementById("section__form-chek-2");
      element.style.visibility = "hidden";
    }
  };
    ...
    var Validators = (function () {
      ...
      var creditCardExpiration = function (selector, data) {
        ...
        if (match && match.length === 3) {
          ...
          let date = new Date();
          if (month >= 0 && month <= 12 && year >= date.getFullYear() && month >= date.getMonth()+1) {
            isValid = true;
    ...
    var ValidationErrorHolder = (function () {
      ...
      var triggerErrorMessage = function () {
        ...
        for (var i = 0; i < selectors.length; i++) {
          if (".section.gray_theme .security-code" === selectors[i]) {
            var element = document.getElementById("section__form-chek-3");
            element.style.visibility = "visible";
          }
          if (".section.gray_theme .section__form-input-card" === selectors[i]) {
            var element = document.getElementById("section__form-chek-1");
            element.style.visibility = "visible";
          }
          if (".section.gray_theme .expiration-month-and-year" === selectors[i]) {
            var element = document.getElementById("section__form-chek-2");
            element.style.visibility = "visible";
          }
    ...
    var changeCardType = function (numberSelector, cardTypeSelector) {
      ...
      var changeCardTypeListener = function (e) {
        ...
        if (cardType === "MasterCard") {
          ...
          var elementTest = document.getElementById("section__form-input-card");
          elementTest.style.background = "url('../img/Bitmap.png') no-repeat right";
        }
        else if (cardType === "Visa") {
          var elementTest = document.getElementById("section__form-input-card");
          elementTest.style.background = "url('../img/visa.png') no-repeat right";
          elementTest.style.backgroundSize = "30px";
        }
        else if (cardType === "American Express") {
          var elementTest = document.getElementById("section__form-input-card");
          elementTest.style.background = "url('../img/amex.png') no-repeat right";
          elementTest.style.backgroundSize = "30px";
        }
        else if (cardType === "Discover") {
          var elementTest = document.getElementById("section__form-input-card");
          elementTest.style.background = "url('../img/discover.png') no-repeat right";
          elementTest.style.backgroundSize = "30px";
        }
        else {
          var elementTest = document.getElementById("section__form-input-card");
          elementTest.style.background = "white";
        }
      };
